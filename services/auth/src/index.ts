import { HelloReply, HelloRequest } from "../lib/typescript/lib/helloworld_pb"
import { GreeterService, IGreeterServer } from '../lib/typescript/lib/helloworld_grpc_pb';
...
function main() {
  ...
  server.bind('0.0.0.0:8080', ServerCredentials.createSsl(
